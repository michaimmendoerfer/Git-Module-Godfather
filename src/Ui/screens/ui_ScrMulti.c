...
void ui_ScrMulti_screen_init(void)
{
    ...
    lv_obj_add_event_cb(ui_ScrMulti, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED, &ui_ScrMulti);
    ...
    lv_obj_set_y(ui_LblMultiScreenName, -145);
    ...
    lv_obj_set_style_text_font(ui_LblMultiScreenName, &lv_font_montserrat_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_ButtonMulti1, 140);
    lv_obj_set_height(ui_ButtonMulti1, 140);
    ...
    ui_object_set_themeable_style_property(ui_ButtonMulti1, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_BtnBg);
    lv_obj_set_style_border_color(ui_ButtonMulti1, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_ButtonMulti1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_ButtonMulti1, 3, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_ButtonMulti2, 140);
    lv_obj_set_height(ui_ButtonMulti2, 140);
    ...
    ui_object_set_themeable_style_property(ui_ButtonMulti2, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_BtnBg);
    lv_obj_set_style_border_color(ui_ButtonMulti2, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_ButtonMulti2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_ButtonMulti2, 3, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_ButtonMulti3, 140);
    lv_obj_set_height(ui_ButtonMulti3, 140);
    ...
    ui_object_set_themeable_style_property(ui_ButtonMulti3, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_BtnBg);
    lv_obj_set_style_border_color(ui_ButtonMulti3, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_ButtonMulti3, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_ButtonMulti3, 3, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_ButtonMulti4, 140);
    lv_obj_set_height(ui_ButtonMulti4, 140);
    ...
    ui_object_set_themeable_style_property(ui_ButtonMulti4, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_BtnBg);
    lv_obj_set_style_border_color(ui_ButtonMulti4, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_ButtonMulti4, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui_ButtonMulti4, 3, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_color(ui_ButtonMulti4, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui_ButtonMulti4, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_width(ui_ButtonMulti4, 20, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_pad(ui_ButtonMulti4, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_BtnMultiLast, 200);
    lv_obj_set_y(ui_BtnMultiLast, 60);
    ...
    lv_obj_set_x(ui_BtnMultiNext, 200);
    lv_obj_set_y(ui_BtnMultiNext, -20);
