...
void ui_ScrJSON_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_ScrJSON, &ui_img_576858027, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui_TxtJSON1, 200, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LblJSON2, lv_color_hex(0xCCCCCC), LV_PART_MAIN | LV_STATE_DEFAULT);
